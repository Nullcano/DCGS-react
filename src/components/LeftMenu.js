...
import Character from '../assets/img/girl-cat.gif';

const LeftMenu = () => (
    <nav className="GameMenu fixed left-0 bottom-0 w4">
        ...
        <div className="Progress ProgressNrg bg-dark">
            <div className="ProgressNrgValue w-80 h-100 bg-dcgs"></div>
        </div>
        <div className="Progress ProgressLvl bg-dark">
            <div className="ProgressLvlValue w-40 h-100 bg-dcgs"></div>
        </div>
        <div className="Avatar relative ma3 w4 h4 br-100 bg-gray" style={{backgroundImage: 'url('+ Character +')'}}></div>
        </ul>
    </nav>
)
